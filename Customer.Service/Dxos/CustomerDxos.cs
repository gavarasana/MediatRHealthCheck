...
namespace Customer.Service.Dxos
{
    public class CustomerDxos : ICustomerDxos
    {
        ...
        public IEnumerable<CustomerDto> MapCustomerDtos(IEnumerable<Domain.Models.Customer> customers)
        {
            return _mapper.Map<IEnumerable<Domain.Models.Customer>, IEnumerable<Domain.Dtos.CustomerDto>>(customers);
        }
    }
}